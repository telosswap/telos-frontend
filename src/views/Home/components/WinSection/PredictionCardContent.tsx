...
import { ArrowForwardIcon, Button, Flex, Heading, Skeleton, Text } from 'packages/uikit'
...
const PredictionCardContent = () => {
  ...
  const bnbWonText = t('$%bnbWonInUsd% in TLOS won so far', { bnbWonInUsd: '#placeholder#' })
