import { Flex, Text, Button, ArrowUpIcon, LinkExternal } from 'packages/uikit'
  ...
  return (
    <>
      <Flex p="16px" flexDirection="column" alignItems="center" justifyContent="space-between" height="150px">
        ...
        <LinkExternal href={getBscScanLink(txHash, 'transaction', chainId)}>{t('View on Telos Explorer')}</LinkExternal>
      </Flex>
      <Divider />
