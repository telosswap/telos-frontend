...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Wagyuswap Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Wagyuswap Bunny NFTs at the snapshot may also purchase one additional Wagyuswap Squad NFT in the presale for each Wagyuswap Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of WAG spent on Wagyuswap Squad NFTs will be burned as part of our weekly WAG burn.')],
  },
  {
