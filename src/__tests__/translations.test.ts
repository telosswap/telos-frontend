...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master WAG chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of WAG.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's WAG)`,
...
describe('Check translations available', () => {
  ...
  throughDirectory('node_modules/packages/uikit', true)
