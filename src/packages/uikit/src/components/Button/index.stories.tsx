...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://exchange.wagyuswap.app" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://exchange.wagyuswap.app" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
