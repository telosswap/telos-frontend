...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://exchange.wagyuswap.app/images/tokens/${token.address[56]}.png`
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://exchange.wagyuswap.app/images/tokens/${token.address[56]}.png`
        const secondarySrc = `https://exchange.wagyuswap.app/images/tokens/${tokens[randomTokenIndex].address[56]}.png`
