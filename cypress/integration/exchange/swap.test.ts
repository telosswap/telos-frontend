describe('Swap', () => {
  ...
  // This test requires account with some amount of VLX on it
  // Now with random private key it shows Insufficient VLX Balance button
  it.skip('can swap VLX for BUSD', () => {
  ...
  it('should get input and output currency from url params', () => {
    cy.visit('/swap?inputCurrency=0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56&outputCurrency=VLX')
